...
class SceneEditor extends System {
  ...
  update(): void {
    ...
    this.engine.queryN(this.attachInteractiveToAllSprites, Sprite);
    this.engine.queryN(this.pushInteractiveEntityToRedux, InteractiveEvent);
    this.engine.queryN(this.pushDragEntityToRedux, DragEvent);
